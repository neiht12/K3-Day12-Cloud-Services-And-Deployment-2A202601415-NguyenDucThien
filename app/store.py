...
class ConversationStore:
    ...
    def append(self, user_id: str, role: str, content: str) -> None:
        ...
        """
        self.client.rpush(self._key(user_id), json.dumps({"role": role, "content": content}, ensure_ascii=False))
        self.client.ltrim(self._key(user_id), -HISTORY_MAX_MESSAGES, -1)
        self.client.expire(self._key(user_id), HISTORY_TTL_SECONDS)
    ...
    def get_history(self, user_id: str) -> list[dict]:
        ...
        """
        history = self.client.lrange(self._key(user_id), 0, -1)
